...
def main_menu():
    ...
    while(running):
        ...
        # boutons
        start_button = Button(image=pygame.image.load("assets/sprites/png/buttons/Start_Game_button.png"), x=520 , y=300)
        options_button = Button(image=pygame.image.load("assets/sprites/png/buttons/options_button.png"), x=520, y=400)
...
def options():
    ...
    while running:
        ...
        # boutons
        back_button = Button(image=pygame.image.load("assets/sprites/png/buttons/back_button.png"), x=500, y=450)
